...
import member from '../../Redux/Members/action';
...
const MemberFile = () => {
	...
	const onFinish = (values: any) => {
		dispatch(member.createMemberReport(values))
						...
						<Col span={24}>
							...
							<div>
								<Col span={12}>
												...
												<>
													{fields.map((field ,index)=> (
														<Row justify='space-between' key={index}>
															...
															<Col span={10} className={'number-input'}>
																<Form.Item
																	{...field}
																	label="Number"
															...
															<Col span={4} className={'number-input'}>
																<Form.Item
																	{...field}
																	label="Poste/ ext"
									...
									<div style={{ overflow: 'hidden' }}>
										<Form.Item name="member1" valuePropName="checked"
											rules={[
												{
													validator: (_, value) =>
									...
									<div style={{ overflow: 'hidden' }}>
										<Form.Item name="member2" valuePropName="checked"
											rules={[
												{
													validator: (_, value) =>
														value ? Promise.resolve() : Promise.reject(new Error('Should accept agreement')),
