...
import { RedoOutlined, CopyOutlined, FileExcelOutlined, FundOutlined } from '@ant-design/icons';
        ...
        <Row justify="space-between" className={'margin-20'}>
          <Col span={11}>
            <Card className={'height-100'}>
              ...
              <Typography className={'graph-fontStyle'}>137</Typography>
            </Card>
          </Col>
          <Col span={11}>
            <Card className={'height-100'}>
              <Typography className={'font-color'}>Members correspondantes</Typography>
              <Typography className={'graph-fontStyle'}>204</Typography>
            </Card>
          </Col>
        </Row>
        <Row justify="space-between" className={'margin-20'}>
          <Col span={11}>
            <Card className={'height-100'}>
              <Typography className={'font-color'}>Interventions correspondantes</Typography>
              <Typography className={'graph-fontStyle'}>367</Typography>
            </Card>
          </Col>
          <Col span={11}>
            <Card className={'height-100'}>
              <Typography className={'font-color'}>Members correspondantes</Typography>
              <Typography className={'graph-fontStyle'}>20</Typography>
            </Card>
          </Col>
        </Row>
      </div>
